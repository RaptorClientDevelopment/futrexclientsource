...
public final class SearchGui extends GuiScreen
{
    ...
    public void func_73866_w_() {
        this.listGui = new ListGui(this.field_146297_k, this, SearchGuiSettings.getBlockNames(), 500, 0);
        this.Allblocks = new ListGui(this.field_146297_k, this, SearchGuiSettings.getAllBlockNames(SearchGuiSettings.getBlockNames()), 0, 0);
    ...
    protected void func_146284_a(final GuiButton button) throws IOException {
        ...
        switch (button.field_146127_k) {
            ...
            case 3: {
                ...
                final Module Search = ModuleManager.getModuleByName("Search");
                if (Search.isToggled()) {
    ...
    private static class ListGui extends GuiScrollingList
    {
        ...
        public ListGui(final Minecraft mc, final SearchGui screen, final List<String> list, final int offsetx, final int offsety) {
